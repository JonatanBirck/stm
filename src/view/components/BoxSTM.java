    ...
    private JPanel createNewBox(Point size){
        ...
        jpanel1.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                ...
                switch(classObject)
                {
                    case "user" : UserView userView = new UserView(idObject);
                        break;
                    case "department" : DepartmentView departmentView = new DepartmentView(idObject);
                        break;
                    case "function" : FunctionView functionView = new FunctionView(idObject);
                        break;                        
                    case "sector" : SectorView sectorView = new SectorView(idObject);
                        break;     
                    case "task" : TaskView taskView = new TaskView(idObject);
                        break;                
                }
            }});         
        //ICON
