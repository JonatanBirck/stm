...
public class CRUDView extends JPanel {
    ...
    */
    ...
    public CRUDView(String object, Point size){
        this.object = object;
        this.size = size;
        initComponents();
    }
    
    public CRUDView(String object, int stateTask, Point size){
        this.object = object;
                ...
                switch(stateTask)
                {
                    case 0 :
                        ...
                        for(Task task : tasks)
                        {
                            ...
                            jpanelBoxes.add(new BoxSTM(task.getId(),"task",state,task.getName(),task.getDateCreate().toString(),stateColor,new Point(250,250)));
                        }
